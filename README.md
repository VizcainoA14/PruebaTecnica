...
nota: para la correcta ejecucion del backend es necesaario este paso, existe una libreria por defecto que debe desinstalarce y ademas el ambiente virtual debe tener en su estructura las carpetas : 
